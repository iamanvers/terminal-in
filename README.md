...
![tests](https://img.shields.io/badge/tests-266_passing-brightgreen)
...
# Tests
.venv\Scripts\pytest tests\ -v                        # 266 tests
```
...
tests/                  266 tests (gate, broker, persistence, filters, planner, supervisor,
