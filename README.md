...
![tests](https://img.shields.io/badge/tests-243_passing-brightgreen)
...
# Tests
.venv\Scripts\pytest tests\ -v                        # 243 tests
```
...
tests/                  243 tests (gate, broker, persistence, filters, planner, supervisor,
