...
![tests](https://img.shields.io/badge/tests-271_passing-brightgreen)
...
# Tests
.venv\Scripts\pytest tests\ -v                        # 271 tests
```
...
tests/                  271 tests (gate, broker, persistence, filters, planner, supervisor,
