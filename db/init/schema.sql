...
CREATE INDEX IF NOT EXISTS idx_lineage_instrument ON signal_lineage(instrument_token, generated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_risk_strategy ON risk_decisions(strategy_id, decided_at DESC);
CREATE INDEX IF NOT EXISTS idx_risk_time     ON risk_decisions(decided_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_snapshot_time ON portfolio_snapshots(snapshot_time DESC);
